...
<head>
	...
	<link rel="shortcut icon" href="assets/images/favicon.png" type="image/x-icon">
		<!-- bootstrap -->
	<link rel="stylesheet" href="wp-content/themes/twentytwentyone/assets/css/bootstrap.min.css">
	<!-- Plugin css -->
	<link rel="stylesheet" href="wp-content/themes/twentytwentyone/assets/css/plugin.css">

	<!-- stylesheet -->
	<link rel="stylesheet" href="wp-content/themes/twentytwentyone/assets/css/style.css">
	<!-- responsive -->
	<link rel="stylesheet" href="wp-content/themes/twentytwentyone/assets/css/responsive.css">
	<!-- font-awsome  -->
	
</head>
	<!-- jquery -->
	<script src="wp-content/themes/twentytwentyone/assets/js/jquery.js"></script>
	<!-- popper -->
	<script src="wp-content/themes/twentytwentyone/assets/js/popper.min.js"></script>
	<!-- bootstrap -->
	<script src="wp-content/themes/twentytwentyone/assets/js/bootstrap.min.js"></script>
	<!-- plugin js-->
	<script src="wp-content/themes/twentytwentyone/assets/js/plugin.js"></script>
	<!-- main -->
	<script src="wp-content/themes/twentytwentyone/assets/js/main.js"></script> 
						...
						<div class="col-lg-12">                 
							<nav class="navbar navbar-expand-lg navbar-light">
								...
								<div class="collapse navbar-collapse fixed-height" id="main_menu">
									...
									<a href="#" class="mybtn1">Start Borrowing</a>
								</div>
							</nav>
						</div>
					</div>
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-6 d-flex align-self-center">
					<div class="left-content">
						<div class="content">
							...
							<p class="text">
								Borrow, Lend with best rated investors and borrowers							   
							</p>
							<div class="links">
				...
				<div class="col-lg-6 order-first order-lg-last">
					<div class="right-img">
						<img src="assets/images/heroright2.png" alt="">
					</div>
				</div>
			</div>
		</div>
				...
				<div class="row justify-content-center">
					<div class="col-lg-8 col-md-10">
						<div class="section-heading">
							...
							<p class="text">
								Here are a few reasons why you should these investors
							</p>
						</div>
					</div>
				</div>
					...
					<div class="col-lg-6">
						<div class="single-why">
							...
							<div class="right">
								...
								<p class="text">
								Easy to work with, i recommend this company to anyone looking for business capital.
								</p></br>
								<p class="text">
								<div class="investor-review">
								 <div class="text-box">
									<ul class="stars">
														<li>
				...
				<div class="row justify-content-center">
					<div class="col-lg-8 col-md-10">
						<div class="section-heading">
							...
							<h2 class="title">
								LoanPortal In Numbers
							</h2>
							<p class="text">
									LoanPortal has a variety of features that make it the best place to start trading
							</p>
						</div>
					</div>
				</div>
					...
					<div class="col-lg-7 order-first order-lg-last">
						<div class="right-area">
							<div class="section-heading">
								...
								<p class="text">
									We’re committed to making our clients successful by becoming their partners and trusted advisors .LoanPortal  believes in being your trusted partner and earning that trust through confidence  
				...
				<div class="container">
					<div class="row">
						<div class="col-lg-12">
							<div class="content">
								<div class="content">
									<p>Copyright © 2019.All Rights Reserved By <a href="#">LoanPortal</a>
									<a href="#">
														<i class="fab fa-facebook-f"></i>
													</a>
